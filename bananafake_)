local function NotificacaoNightMystic(titulo, mensagem)
    ...
    local LogoID = "rbxassetid://114578517500917"
...
NotificacaoNightMystic("RedzRoblox", "Script carregado com sucesso!")

repeat task.wait() until game:IsLoaded()

local HttpService = game:GetService("HttpService")
local FolderName = "RedzRoblox"
...
local I = (loadstring(game:HttpGet("https://raw.githubusercontent.com/duy260414-lang/Redzroblox/refs/heads/main/Uireal")))();
if World1 then
	Boss = {
			"The Gorilla King",
			"Bobby",
...
Discord_Info:AddDiscord("RedzRoblox", "z58xwgQq")
